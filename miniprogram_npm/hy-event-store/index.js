...
__DEFINE__(1644845213816, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1644845213817,"./event-store":1644845213818}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644845213817, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1644845213818, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1644845213817,"./utils":1644845213819}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1644845213819, function(require, module, exports) {
...
return __REQUIRE__(1644845213816);
})()
